# Orange ISP ONU GPON-ONU-34-20BI
...
GPON SFP ONU stick configuration, serial/vendor identity, speed mode, OMCI logs and VLAN troubleshooting.
...
Source note: `Orange ISP ONU GPON-ONU-34-20BI.md`
...
ALCATEL OLT (mixed G-PON / XGS-PON) :
```
